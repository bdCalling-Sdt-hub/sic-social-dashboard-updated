...
import { useAddAdminMutation, useGetAdminQuery, useUpdateAdminStatusMutation } from '../../redux/api/adminApi';
      ...
      return (
            <div>
                  ...
                  >
                        ...
                        <div>
                              <Table pagination={false} columns={columns} style={{}} dataSource={adminData?.data} />
                        </div>
                  </div>
                  <Modal
                        centered
                  ...
                  >
                        <div className="p-6 ">
                              <h1 className="font-semibold text-black text-xl" style={{ marginBottom: '12px' }}>
                                    {`Add new Admin`}
                              </h1>
