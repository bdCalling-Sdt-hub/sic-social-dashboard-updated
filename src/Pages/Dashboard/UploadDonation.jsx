...
import { useAddDonationMutation, useGetDonationQuery, useUpdateDonationMutation } from '../../redux/api/donationApi';
      ...
      const items = [
            {
                  ...
                  children: <Details setActiveTab={setActiveTab} setDetailsData={setDetailsData} />,
            },
            {
                  key: '2',
                  label: <p className="px-4">Rules & Regulations </p>,
                  children: <Rules setActiveTab={setActiveTab} setRulesData={setRulesData} />,
            },
            {
                  key: '3',
